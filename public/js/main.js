...
const updateTheme = () => {
    if (darkMode) {
        ...
        document.documentElement.style.setProperty('--white-color', '#18181f');
        document.documentElement.style.setProperty('--light-color', '#080810');
        ...
        document.documentElement.style.setProperty('--dark-color', '#18181f');
